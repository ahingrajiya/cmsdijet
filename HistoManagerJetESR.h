...
class HistoManagerJetESR : public BaseHistoManager
{
   public:
    ...
    void setCentRange(const Double_t &lo = 0, const Double_t &hi = 60)
    {
        fCentRange[0] = lo;
        fCentRange[1] = hi;
    }
    ...
    void setJetPtRange(const Double_t &lo = 0., const Double_t &hi = 1000.)
    {
        fPtRange[0] = lo;
        fPtRange[1] = hi;
    }
    ...
    /// @brief Set eta range
    void setJetEtaRange(const Double_t &lo = -2.5, const Double_t &hi = 2.5)
    {
        fEtaRange[0] = lo;
        fEtaRange[1] = hi;
    }
    ...
    /// @brief Set phi range
    void setJetPhiRange(const Double_t &lo = -TMath::Pi(), const Double_t &hi = TMath::Pi())
    {
        fPhiRange[0] = lo;
        fPhiRange[1] = hi;
    }
    ...
    /// @brief Set JES range
    void setJESRange(const Double_t &lo = 0., const Double_t &hi = 5.)
    {
        fJESRange[0] = lo;
        fJESRange[1] = hi;
    }
    ...
    void setFlavorForBRange(const Double_t &lo = -6.5, const Double_t &hi = 6.5)
    {
        fFlavorForBRange[0] = lo;
        fFlavorForBRange[1] = hi;
    }
    /// @brief Set number of bins for ptHat
    void setPtHatBins(const Int_t &n = 10) { fPtHatBins = n; }
    /// @brief Set range of ptHat
    void setPtHatRange(const Double_t &lo = 15., const Double_t &hi = 215.)
    {
        fPtHatRange[0] = lo;
        fPtHatRange[1] = hi;
    }
