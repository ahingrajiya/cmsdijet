...
//_________________
class ForestReader : public BaseReader
{
...
public:
  ...
  ForestReader(const Char_t *inputStream, const Bool_t &isAOD = kFALSE, const Bool_t &isMiniAOD = kFALSE,
  ...
  enum class ForestFileType
  {
    AOD,
    MiniAOD
  };
  ///@brief Types of Files
  void setForestFileType(ForestFileType type)
  {
    fIsAOD = (type == ForestFileType::AOD);
    fIsMiniAOD = (type == ForestFileType::MiniAOD);
  }

  enum class CollidingSystemType
  {
    pp,
    pPb,
    PbPb,
  ...
  void setCollidingSystem(CollidingSystemType sys)
  {
    ...
    fIs_PbPb = (sys == CollidingSystemType::PbPb);
    fIs_OO = (sys == CollidingSystemType::OO);
    switch (sys)
    {
...
private:
  ...
  Bool_t fIsAOD;
  /// @brief Flag indicating if the input is MiniAOD
  Bool_t fIsMiniAOD;
